    ...
    <div class="col-md-3 center">
        <div class="login-box">
            <a href="<?= App::url(''); ?>" class="logo-name text-lg text-center">
                <img src="<?= FileHelper::url($user->photo) ?>" class="img-circle img-md" alt="" style="height: 140px; width: 140px;">
            </a>
            ...
            <form class="m-t-md" action="<?= App::url('password/change') ?>" id="changePasswordForm">
                ...
                <button type="submit" style="background: #F93100" class="sendBtn btn btn-success btn-block">Modifier</button>
            </form>
        </div>
    </div>
</div>
