...
App::setTitle("Les Ordis");
App::setNavigation("Les  Ordis");
App::setBreadcumb('<li class="active"> Ordis</li>');
App::addStyle('assets/css/multi-select.css',true);
App::addScript('assets/js/jquery.multi-select.js',true);
App::addScript('assets/js/ordis.js',true);
?>
<div class="row">
    <div class="col-md-12">
        <div class="panel panel-dark">
            <div class="panel-heading">
                ...
                Ordis <small>(<?= thousand($nbre->Total); ?>)</small>
                </h5>
                <div class="panel-control">
                    <?php if(Privilege::canView(Privilege::$AllView,$user->privilege)){ ?>
                        <a href="javascript:void(0);" data-toggle="tooltip" class="new" data-original-title="Nouveau ordis">
            ...
            <div class="panel-body">
                <div class="row m-t-sm">
                    <div class="col-md-12">
                        <form action="<?= App::url('ordis') ?>" method="get">
                                ...
                                if(!empty($items)){
                                    foreach ($items as $ordis) {
                                        ...
                                        if(Privilege::canView(Privilege::$AllView,$user->privilege)){
                                            $stat01 = '<li>
                                                                <a href="javascript:void(0);" data-id="'.$ordis->id.'"
                                                                 data-nom="'.$ordis->nom.'"  data-type="'.$ordis->type.'"
                                        ...
                                        if(Privilege::canView(Privilege::$AllView,$user->privilege)){
                                              ...
                                              $stat04 = '<li>
                                                            ...
                                                            <a href="javascript:void(0);" data-url="'.App::url('ordis/delete').'" 
                                                            class="trash" data-id="'.$ordis->id.'">Supprimer ordis</a>
                                                        </li>';
                                        }
                                        echo
                                            '
                                            <tr>
                                                ...
                                                <td class="">'.$ordis->nom.'</td>
                                                <td class="">'.$ordis->type.'</td>
                                    ...
                                    echo '<tr><td colspan="9" class="text-danger text-center">Liste des ordis  vide ...</td></tr>';
                                }
                                ?>
                                </tbody>
                                <?php
...
<div class="modal fade newModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= App::url('ordis/save') ?>" id="newForm" method="post">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 form-group">
                            <label for="prenom">type<b>*</b></label>
